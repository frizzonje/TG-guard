...
### Безопасность
- Работает только с группами и личными диалогами
- Каналы (broadcast) полностью игнорируются
- Обработка ошибок FloodWait для избежания блокировок
- Валидация юзернеймов при добавлении
...
- Программа не может удалять сообщения других пользователей
- Безопасная работа с API Telegram
- Валидация входных данных

## 📝 Логи

Программа ведёт подробные логи всех операций:
- Удаление сообщений
...
Программа регулярно обновляется для:
- Совместимости с новыми версиями Telegram API
...
4. Убедитесь в актуальности API ключей
5. Попробуйте сбросить настройки к исходным

---

**TG-Guard** - надёжный защитник вашего Telegram пространства! 🛡️
